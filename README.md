...
Before you can make requests to the API, you must enable API Access and configure a RESTful API Client resource in the AuthPoint management UI [[WatchGuard documentation](https://www.watchguard.com/help/docs/API/Content/en-US/multi-factor_authentication/authentication/v1/authentication.html#Authentication_API)].
...
Invoke-MoDMfa -Provider AuthPoint -TenantId <AccountId>:<ResourceId> -User <user> -Mode Push
```
